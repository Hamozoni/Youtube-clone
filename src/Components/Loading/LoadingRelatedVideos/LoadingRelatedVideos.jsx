      ...
      <div className={`${display} loader-conyainer`}>
        {
          cards.map((e) => (
            ...
            <div className={`${display} loader-card`} key={e}>
              <div className={`back-color-${theme}-1 ${display}  back-before-c-${theme}-2 loader-image loader-moviement`}></div>
              <div className="loader-box ">
                <div className={`back-color-${theme}-1  back-before-c-${theme}-2  image loader-moviement`}></div>
